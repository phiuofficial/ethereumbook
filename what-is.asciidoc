...
////
you should make clear what you mean for blockchain in the book from now on: the glossary explains the database piece, while here and very often from now on you are probably referring to a software technology comprised of p2p, crypto, blockchain and consensus algorithms
////
